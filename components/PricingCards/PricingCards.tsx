    ...
    <section id="pricing-cards">
      <div className="flex min-h-screen items-center justify-center px-10  bg-lilac">
        <div className="bg-white p-4 rounded-xl">
          <div className="grid grid-cols-1 md:grid-cols-3 p-10 bg-lilac rounded-xl gap-x-6">
            {pricingCardsData.map((card) => (
              <div key={card.id} className="">
                ...
                <p className="text-sm font-semibold text-gray-700 pt-6 pb-11">{card.description}</p>
                <a
                  href="#"
                  className={classNames(
                    "text-black p-4 rounded-lg w-full shadow-sm hover:bg-opacity-90 hover:shadow-lg transition hover:-translate-y-0.5 duration-150 text-sm font-semibold",
