      ...
      <div className="flex min-h-screen items-center justify-center bg-superLightBlue px-10">
        ...
        <div className="relative flex flex-col max-w-xs">
          ...
          <div className="relative z-10 flex flex-col rounded-2xl">
            ...
            <div className="flex flex-col rounded-b-2xl bg-white p-7 space-y-3">
              ...
              <button className="text-white bg-deepNavyBlue py-3 rounded-full w-full shadow-sm hover:bg-opacity-90 hover:shadow-lg transition hover:-translate-y-0.5 duration-150">Buy now</button>
            </div>
          </div>
        </div>
      </div>
