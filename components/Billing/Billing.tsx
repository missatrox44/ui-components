          ...
          <div className="bg-lighterlilac rounded-l-2xl z-10 w-fit py-8">
            ...
            <ul className="pl-2 text-gray-500 text-lg space-y-7 font-light mb-44">
              {menuItems.map(({ isSelected, icon: Icon, menuName }, index) => (
                <li
                  key={index}
                  className={`flex items-center space-x-4 pl-8  ${isSelected ? "border-l-[6px] border-l-orangeish" : ""
                    }`}
                >
          ...
          <div className="z-10 bg-white rounded-r-2xl py-14 px-10 ">
            ...
            <div className="flex space-x-20">
              <div className="flex flex-col">
                ...
                <a href="#" className="text-orangeish hover:underline pl-4">Load more</a>
                  ...
                  <p className="font-light text-sm mb-4 pl-4">
                    ...
                    <div className="pl-4 flex items-center">
                      <div className="bg-white w-20 border p-2 rounded mr-4">
                        <img className="w-full" src="/images/visa-logo.png" alt="visa logo" />
                      </div>
